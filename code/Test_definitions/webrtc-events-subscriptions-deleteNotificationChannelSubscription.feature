Feature: CAMARA WebRTC Events Subscriptions, v0.3.0-rc.1 - Operation deleteNotificationChannelSubscription

  Background: Common deleteNotificationChannelSubscription setup
    Given an environment at "apiRoot"
    And the resource "/webrtc-events-subscriptions/v0.3rc1/subscriptions/{subscriptionId}"                                                              |
  ...
  @webrtc_events_deleteNotificationChannelSubscription_01_generic_success_scenario
  Scenario: Delete a webrtc-events-subscriptions event subscription
  ...
  @webrtc_events_deleteNotificationChannelSubscription_404_subscription_not_found
  ...
  @webrtc_events_deleteNotificationChannelSubscription_400.1_no_request
  ...
  @webrtc_events_deleteNotificationChannelSubscription_400.2_empty_request
  ...
  @webrtc_events_deleteNotificationChannelSubscription_401.1_no_authorization_header
  ...
  @webrtc_events_deleteNotificationChannelSubscription_401.2_expired_access_token
  ...
  @webrtc_events_deleteNotificationChannelSubscription_401.3_invalid_access_token
