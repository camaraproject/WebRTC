Feature: CAMARA WebRTC Call Handling, v0.4.0-rc.1 - Operation updateSessionStatus

  Background: Common updateSessionStatus setup
    Given an environment at "apiRoot"
    And the resource "/webrtc-call-handling/v0.4rc1/sessions/{mediaSessionId}/status"                                                              |
