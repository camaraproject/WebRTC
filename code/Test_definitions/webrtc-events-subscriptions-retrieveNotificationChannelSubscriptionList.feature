Feature: CAMARA WebRTC Events Subscriptions, v0.3.0-rc.1 - Operation retrieveNotificationChannelSubscriptionList

  Background: Common retrieveNotificationChannelSubscriptionList setup
    Given an environment at "apiRoot"
    And the resource "/webrtc-events-subscriptions/v0.3rc1/subscriptions"                                                              |
