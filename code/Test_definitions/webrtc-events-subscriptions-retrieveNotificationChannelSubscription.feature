Feature: CAMARA WebRTC Events Subscriptions, v0.3.0-rc.1 - Operation retrieveNotificationChannelSubscription
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_404_subscription_not_found
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_400.1_no_request
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_400.2_empty_request
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_401.1_no_authorization_header
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_401.2_expired_access_token
  ...
  @webrtc_events_retrieveNotificationChannelSubscription_401.3_invalid_access_token
